...
# (e.g. `brew tap agix-ai/agix && brew install agix-aos`). See scripts/release/README.md.
class AgixAos < Formula
  ...
  url "https://github.com/agix-ai/homebrew-agix/releases/download/v0.2.2/agix-aos-0.2.2.tar.gz"
  version "0.2.2"
